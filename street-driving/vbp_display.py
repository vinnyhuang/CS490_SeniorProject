...
HEIGHT_OFFSET_TOP, HEIGHT_OFFSET_BOTTOM = 106, 0
ORIGINAL_HEIGHT, ORIGINAL_WIDTH = 256, 455
...
def preprocess(image):
    ...
    """
    if HEIGHT_OFFSET_BOTTOM == 0:
        image = image[HEIGHT_OFFSET_TOP :, :, :]
    else:
        image[HEIGHT_OFFSET_TOP : -1 * HEIGHT_OFFSET_BOTTOM, :, :]
